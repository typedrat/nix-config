...
with lib; let
  ...
  isWrapped =
    versionAtLeast config.home.stateVersion "19.09"
    && wrappedPackageName != null;
  ...
  mkUserJs = prePrefs: prefs: extraPrefs: bookmarks: extensions: let
    prefs' =
  ...
  browserBookmarksFile = bookmarks: let
    indent = level:
    ...
    profiles = mkOption {
      ...
      type = types.attrsOf (types.submodule ({
        ...
        options = {
          ...
          extensions = mkOption {
            type =
              types.coercedTo (types.listOf types.package) (packages: {
