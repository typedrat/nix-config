...
stdenvNoCC.mkDerivation (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    hash = "sha256-oIqfHwVidqO1skZc1j/de3lKHp/+Nqv7Op7quH7XbsA=";
  };
  ...
  passthru = {
    ...
    promptOverrides = fetchFromGitHub {
      ...
      rev = "734910f4c54a992bfaece5c8d078554e094df665";
      hash = "sha256-7k5wJy1MbAk2ahEBwodRJoZgiZGFl/cBvwAtxTv6RR0=";
    };
